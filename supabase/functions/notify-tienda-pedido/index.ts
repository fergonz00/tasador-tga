// Edge Function: notify-tienda-pedido
// La dispara la tienda de repuestos (tienda.baratito.com.ar, /api/cron/leads) cuando
// alguien pide una pieza por el formulario, JUSTO DESPUES de crear el lead en el CRM.
//
// Por que aparte del aviso del CRM: el del CRM solo dice nombre, telefono y origen, asi
// que quien atiende no sabe que pieza pidieron sin entrar al sistema. Este manda el pedido
// entero (pieza, codigo, precio, stock nuestro y de fabrica, link a la ficha) para que se
// pueda contestar desde el celular. El cierre igual se carga en el CRM (Fer, 20-09-2026).
//
...
const DESTINATARIOS_DEFAULT = "gorozco,repuestos,fngonzalez"; // Fer quiere recibir cada pedido (21-09-2026)
...
const TEMPLATE_COMPONENTS = [
  {
    ...
    example: {
      body_text: [[
        "German",
        "Filtro de aceite 04E-115-561-T",
        "Juan Perez, 11 5555-1234 · $44.700 con IVA · En stock (217 u.) · Para Taos, Polo y T-Cross · tienda.baratito.com.ar/pieza/04E115561T",
      ]],
    },
  },
];
